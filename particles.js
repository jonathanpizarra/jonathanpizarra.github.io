...
const init = ()=>{
    ...
    //     particles.push(new Particle( ((w - (w%s) ) / 2) - ( ((w - (w%s) ) / 2) %s) , ((h - (h%s) ) / 2) - ( ((h - (h%s) ) / 2) %s) , color, s, s, w, h));
    //     particles[z].dir_x = default_directions[z%4][0];
    //     particles[z].dir_y = default_directions[z%4][1];
    //     //console.log(color);
    // }
